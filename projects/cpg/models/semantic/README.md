# dbt Semantic Layer definitions for the consumer packaged goods track

**The definitions are not in this folder. They are in
[`../marts/_cpg__marts.yml`](../marts/_cpg__marts.yml).**
...
- **[`../marts/_cpg__marts.yml`](../marts/_cpg__marts.yml)** for the metrics, entities and
  dimensions. Look for the `semantic_model:` and `metrics:` blocks under each
  mart.
- **[`../marts/`](../marts/)** for sv_cpg_commercial_performance.sql, the Snowflake Semantic View,
...
have one yet. If you add one, put it here as `cpg.yml`.
